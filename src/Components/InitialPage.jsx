	...
	return (
		<div className="relative">
			...
			<button 
				...
				className="main-button block text-darkGreen font-bold text-lg mx-auto sm:mt-44 mt-32 w-52 px-8 py-3 bg-lightBlue dark:bg-darkOrange overflow-hidden dark:text-yellow hover:bg-darkGreen dark:hover:bg-yellow dark:hover:text-darkGreen dark:hover:border-lightOrange">
				START THE GAME
